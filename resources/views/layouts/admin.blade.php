                    ...
                    <button data-dropdown
                        ...
                        <div data-dropdown-items
                            ...
                            <ul>
                                ...
                                <li class="px-4 py-3 border-b hover:bg-gray-200">
        ...
        <div class="flex flex-row">
            <div
                ...
                <div class="sidebar text-center bg-gray-900">
                    ...
                    <a href="{{ route('produkadmin.index') }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                    ...
                    <a href="{{ route('adminstock.index') }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                            <i class="bi bi-file-text-fill"></i>
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Stock</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.pengajuansewa', ['id_pesanan' => auth()->id()]) }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                            <i class="bi bi-bell-fill"></i>
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Pengajuan Sewa</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.statistikpenjualanproduk', ['id_pesanan' => auth()->id()]) }}">
                        <div
                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                            <i class="bi bi-book-fill"></i>
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Statistik Penjualan</span>
                        </div>
                    </a>
